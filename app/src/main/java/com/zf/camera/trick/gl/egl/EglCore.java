...
package com.zf.camera.trick.gl.egl;
...
public final class EglCore {
    ...
    public EglCore(EGLContext sharedContext, int flags) {
        ...
        if ((flags & FLAG_TRY_GLES3) != 0) {
            ...
            if (config != null) {
                ...
                if (EGL14.eglGetError() == EGL14.EGL_SUCCESS) {
                    TrickLog.d(TAG, "Got GLES 3 config");
                    mEGLConfig = config;
                    mEGLContext = context;
                    mGlVersion = 3;
                }
        ...
        TrickLog.d(TAG, "EGLContext created, client version " + values[0]);
    }
