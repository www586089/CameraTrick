...
class EncodingTestActivity : AppCompatActivity() {
    private val TAG = "A-Encode"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnStartEncodingAsync =
            findViewById<android.widget.Button>(R.id.btn_start_encoding_async)
            ...
            for (x in startX + videoWidth / 4 - 1 downTo startX) {
                if (semiPlanar) {
                    ...
                    if (x and 0x01 == 0 && y and 0x01 == 0) {
                        ...
                        frameData[videoWidth * videoHeight + y * HALF_WIDTH + x + 1] =
                            TEST_V.toByte()
                    }
                } else {
                    ...
                    frameData[y * videoWidth + x] = TEST_Y.toByte()
                    if (x and 0x01 == 0 && y and 0x01 == 0) {
                        frameData[videoWidth * videoHeight + y / 2 * HALF_WIDTH + x / 2] =
                            TEST_U.toByte()
